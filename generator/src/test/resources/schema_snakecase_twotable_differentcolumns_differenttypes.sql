...
insert into Alpha_Person values (default, 'Joe', 'Bloggs', 22, 'blah', 55, 'Wonkles');
insert into Alpha_Person values (default, 'Jack', 'Ripper', 33, 'blah', 66, 'Ginkles');

insert into Bravo_Person values (default, 'George', 'blah', 'Oleaf', 22, 77, 1);
insert into Bravo_Person values (default, 'Greg', 'blah', 'Raynor', 33, 88, 2);
